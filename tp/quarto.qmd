...
author: Joseph Salmon, Benjamin Charlier
---
...
Commençons par créer notre exemple minimal. Le code et le markdown suivants forment le contenu d'un fichier appelé `rapport_tp.qmd`^[et le rendu donne alors un fichier `.pdf` ressemblant à cela :![Sortie `.pdf` du fichier `rapport_tp.qmd` ](https://github.com/josephsalmon/HAX603X/blob/main/TP/Images/quarto_demo.jpg)] :
